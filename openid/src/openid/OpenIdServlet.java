...
public class OpenIdServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        manager.setRealm("http://modrictest.appspot.com");
        manager.setReturnTo("http://modrictest.appspot.com/openid");
    }
    ...
    void showAuthentication(PrintWriter pw, Authentication auth) {
        pw.print("<html><head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" /><title>Kollaidoscope</title></head><body><h1>You have successfully signed on!</h1>");
